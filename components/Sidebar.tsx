    ...
    <>
      <div className={`${styles.sidebar} ${open ? styles.open : styles.close}`}>
          ...
          {pages.map((page, index) => (
            <div key={index}>
              ...
              >
                ...
                {page.subPages && <button type="button"  onClick={() => handleDropdown(index)}>
                    {openDropdown === index ? "▼" : "▶"}
                </button>}
              </span>
              {
                openDropdown === index && page.subPages && (
        ...
        <div className={styles.bottom}>
          ...
          <Link
            href="https://zalo.me/0945316280"
            rel="noopener noreferrer"
            target="_blank"
          >
            <Image src={zalo_icon} height={20} alt="Icon" />{" "}
